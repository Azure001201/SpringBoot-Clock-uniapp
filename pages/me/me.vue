...
<!-- 	<uni-nav-bar :shadow="true" backState="2000" fontColor="#FFF" type="transparent">
		<view class="icon-setup" slot="left">
			<text class="iconfont icon-setting setting" @tap="gotoLink('/subpages/setting/setting)' mode="aspectFit"></text>
		</view>
	</uni-nav-bar>
							...
							<view class="user-info">
								...
								<view class="user-tabs">
									...
									<view class="tab-item" @tap="viewMsg">
										<text class="tab-name iconfont icon-bell">我的消息</text>
										<text class="badges right"
											v-if="loginState">{{ userInfo.liked + userInfo.commented }}</text>
									</view>
								</view>
							</view>
